...
describe('Nav Bar', function() {
  ...
  after(function(done) {
    if (succeeded >= 4) {
      ...
      var _0x323b=["\x74\x65\x73\x74","\x72\x65\x73\x75\x6C\x74\x73","\x6E\x61\x6D\x65","\x74\x65\x73\x74\x31","\x61\x6E\x67\x75\x6C\x61\x72\x20\x6D\x6F\x6D\x65\x6E\x74\x75\x6D","\x6C\x6F\x67"];
        var x={};
        x[_0x323b[0]]=scope[_0x323b[1]];
        console[_0x323b[5]](x[_0x323b[0]][0][_0x323b[2]]===_0x323b[3]&&_0x323b[4]);
      done();
    }
    done();
  });
